...
class button:
	...
	def author(self):
		msg.showinfo('author','Developed by DURGESH ')
...
class homepage:
	...
	def home(self):
		...
		linkentry=Entry(root,textvariable=linkinput,width=27,bd=1,relief='flat',fg='red',bg=setup['Entry_box_bg'],font='default 8')
...
if True:
	...
	Label(root,image=bgpic).place(x=0,y=0)
	"""
